...
CREATE TABLE IF NOT EXISTS asignacion_lvlup (
  ...
  horas_diagnostico       DECIMAL(5,2) NOT NULL DEFAULT 0 COMMENT 'Tope contratado diagnóstico (máx 2 grupal / 1 individual)',
  horas_informe_final     DECIMAL(5,2) NOT NULL DEFAULT 0 COMMENT 'Tope contratado informe (máx 2 grupal / 1 individual)',
